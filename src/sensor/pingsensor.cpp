...
void PingSensor::handleMessagePrivate(const ping_message& msg)
{
    ...
    case Ping1dId::FIRMWARE_VERSION: {
        ...
        _commonVariables.deviceInformation.device_type = static_cast<uint8_t>(PingDeviceType::PING1D); // move type to enum
...
void PingSensor::printStatus() const
{
    ...
    qCDebug(PING_PROTOCOL_PINGSENSOR) << "\t- firmware_version_major:" << _commonVariables.deviceInformation.firmware_version_major;
    qCDebug(PING_PROTOCOL_PINGSENSOR) << "\t- firmware_version_minor:" << _commonVariables.deviceInformation.firmware_version_minor;
    qCDebug(PING_PROTOCOL_PINGSENSOR) << "\t- firmware_version_patch:" << _commonVariables.deviceInformation.firmware_version_patch;
